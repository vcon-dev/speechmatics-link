...
class SpeechmaticsClient:
    ...
    def __init__(self, api_key: str, api_url: Optional[str] = None, timeout: int = 300):
    ...
    def _build_config(self, config: TranscriptionConfig) -> dict:
        ...
        if config.enable_diarization:
            ...
            if config.diarization_max_speakers:
                transcription_config["speaker_diarization_config"] = {"max_speakers": config.diarization_max_speakers}
    ...
    def submit_job(self, audio_url: str, config: Optional[TranscriptionConfig] = None) -> str:
        ...
        job_config["fetch_data"] = {"url": audio_url}
        ...
        try:
            ...
            files = {"config": (None, json_module.dumps(job_config), "application/json")}
    ...
    def wait_for_completion(self, job_id: str, poll_interval: int = 5, max_attempts: int = 120) -> dict:
        ...
        raise SpeechmaticsTimeoutError(f"Job {job_id} did not complete within {max_attempts * poll_interval} seconds")
