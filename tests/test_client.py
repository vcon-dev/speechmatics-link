...
class TestTranscriptionConfig:
    ...
    def test_custom_config(self):
        ...
        config = TranscriptionConfig(
            language="en", operating_point="standard", enable_diarization=True, diarization_max_speakers=5
        )
...
class TestSubmitJob:
    ...
    def test_submit_job_success(self, mock_session_class, api_key, mock_response):
        ...
        mock_session.post.return_value = mock_response(status_code=200, json_data={"id": "job-123"})
    ...
    def test_submit_job_with_config(self, mock_session_class, api_key, mock_response):
        ...
        mock_session = MagicMock()
        mock_session.post.return_value = mock_response(status_code=200, json_data={"id": "job-456"})
        mock_session_class.return_value = mock_session
    ...
    def test_submit_job_no_job_id_error(self, mock_session_class, api_key, mock_response):
        ...
        mock_session = MagicMock()
        mock_session.post.return_value = mock_response(status_code=200, json_data={})
        mock_session_class.return_value = mock_session
...
class TestGetJobStatus:
    ...
    def test_get_job_status_success(self, mock_session_class, api_key, mock_response):
        ...
        mock_session = MagicMock()
        mock_session.get.return_value = mock_response(status_code=200, json_data={"job": {"status": "running"}})
        mock_session_class.return_value = mock_session
...
class TestGetTranscript:
    ...
    def test_get_transcript_success(self, mock_session_class, api_key, mock_response):
        ...
        mock_session.get.return_value = mock_response(status_code=200, json_data=transcript_data)
        mock_session_class.return_value = mock_session
...
class TestDeleteJob:
    ...
    def test_delete_job_failure(self, mock_session_class, api_key, mock_response):
        ...
        mock_session.delete.return_value = mock_response(
            status_code=404, raise_for_status=requests.HTTPError("Not found")
        )
        mock_session_class.return_value = mock_session
